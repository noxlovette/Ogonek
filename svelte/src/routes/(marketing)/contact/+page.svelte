...
<div class="mx-auto max-w-3xl px-4">
  ...
  <div class="grid gap-6 md:grid-cols-2">
    <!-- Email Card -->
    <div
      class="overflow-hidden rounded-lg bg-white shadow-sm transition-all hover:shadow-sm dark:border-stone-700 dark:bg-stone-900"
    >
      <div class="p-6">
        ...
        <div
          class="bg-default flex items-center justify-between rounded-lg p-3 dark:bg-stone-800/30"
        >
          <span
