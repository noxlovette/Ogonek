  ...
  <main>
    ...
    <p class="description">
      Click the button below, and view the sample error on the Sentry <a
        target="_blank"
        href="https://danila-volkov.sentry.io/issues/?project=4507947592777808"
        >Issues Page</a
    ...
    {:else if !isConnected}
      <div class="connectivity-error">
        <p>
          ...
          to an adblocker. For more information, see <a
            target="_blank"
            href="https://docs.sentry.io/platforms/javascript/guides/sveltekit/troubleshooting/#the-sdk-is-not-sending-any-data"
