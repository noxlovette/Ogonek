<script lang="ts">
	...
	<div class="max-w-md w-full space-y-8 bg-white p-8 rounded-xl shadow-lg" 
	  ...
	  <div class="text-center">
		...
		<p class="mt-2 text-sm text-milk-600">Already have an account? 
		  <a href="/login" class="font-medium text-brick-500 hover:text-brick-400">Sign in</a>
		</p>
	  </div>
	  ...
	  <form use:enhance method="post" class="mt-8 space-y-6">
		<div class="space-y-4">
		  ...
		  <div>
			<label for="confirmPassword" class="block text-sm font-medium text-milk-700">Confirm Password</label>
			<input 
			  type="password" 
