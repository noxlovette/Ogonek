...
export const routes = {
  admin: {
    ...
    unpublish_content: (id: string) => `${API_BASE}/admin/content/${id}/publish`,
  },
  auth: {
  ...
  calendars: {
    ...
    events_by_month: (year: string, month: string) => `${API_BASE}/calendars/events/month/${year}/${month}`,
    event: (uid: string) => `${API_BASE}/calendars/events/${uid}`,
    delete_event: (uid: string) => `${API_BASE}/calendars/events/${uid}`,
    update_event: (uid: string) => `${API_BASE}/calendars/events/${uid}`,
    delete_calendar: (id: string) => `${API_BASE}/calendars/${id}`,
    update_calendar: (id: string) => `${API_BASE}/calendars/${id}`,
  },
  content: {
