...
/**
 * @summary Get a single event attendee by ID
 */
export const fetchAttendeeParams = zod.object({
  "id": zod.string().describe('Attendee ID')
})

export const fetchAttendeeResponse = zod.object({
...
export const updateAttendeeBody = zod.object({
  ...
  "name": zod.string().nullish(),
  "role": zod.union([zod.null(),zod.enum(['req-participant', 'chair', 'opt-participant', 'non-participant'])]).optional(),
  "rsvp": zod.boolean().nullish(),
  "status": zod.union([zod.null(),zod.enum(['needs-action', 'accepted', 'declined', 'tentative', 'delegated'])]).optional()
})
...
export const listEventsParams = zod.object({
  "calendar_id": zod.string().describe('Calendar ID')
})
...
export const listAttendeesParams = zod.object({
  "event_id": zod.string().describe('Event ID')
})
...
export const updateEventBody = zod.object({
  ...
  "categories": zod.array(zod.string()).nullish(),
  "class": zod.union([zod.null(),zod.enum(['public', 'private', 'confidential'])]).optional(),
  "description": zod.string().nullish(),
  "dtend": zod.iso.datetime({}).nullish(),
  "dtstamp": zod.iso.datetime({}).nullish(),
  "dtstart": zod.iso.datetime({}).nullish(),
  ...
  "status": zod.union([zod.null(),zod.enum(['confirmed', 'tentative', 'cancelled'])]).optional(),
...
/**
 * @summary Get a single calendar by ID
 */
export const fetchCalendarParams = zod.object({
  "id": zod.string().describe('Calendar ID')
})

export const fetchCalendarResponse = zod.object({
  "colour": zod.string(),
  "description": zod.string().nullish(),
  "id": zod.string(),
  "name": zod.string()
...
export const updateCalendarBody = zod.object({
  "caldavUrl": zod.string().nullish(),
  "colour": zod.string().nullish(),
  "description": zod.string().nullish(),
  "name": zod.string().nullish(),
  "syncToken": zod.string().nullish(),
  "timezone": zod.string().nullish()
})
...
export const listDecksQueryParams = zod.object({
  "page": zod.number().min(listDecksQueryPageMin).optional().describe('Page number'),
  "per_page": zod.number().min(listDecksQueryPerPageMin).optional().describe('Items per page'),
...
export const listLessonsQueryParams = zod.object({
  "page": zod.number().min(listLessonsQueryPageMin).optional().describe('Page number'),
  "per_page": zod.number().min(listLessonsQueryPerPageMin).optional().describe('Items per page'),
  "search": zod.string().optional().describe('Search term'),
  "assignee": zod.string().optional().describe('Filter by assignee')
})
...
export const fetchLessonResponse = zod.object({
  "assignee": zod.string(),
  "assigneeName": zod.string(),
  "createdAt": zod.iso.datetime({}),
  "id": zod.string(),
  ...
  "topic": zod.string(),
  "updatedAt": zod.iso.datetime({})
}).describe('Version to indulge swift OpenAPI Generator. ATTENTION: camelCase may break the iOS app! I fucked up the last build')
...
export const listTasksQueryParams = zod.object({
  "page": zod.number().min(listTasksQueryPageMin).optional().describe('Page number'),
  "per_page": zod.number().min(listTasksQueryPerPageMin).optional().describe('Items per page'),
  "search": zod.string().optional().describe('Search term'),
  "assignee": zod.string().optional().describe('Filter by assignee'),
