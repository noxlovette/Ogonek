...
<div class="relative">
  ...
  >
    ...
    <button
      ...
      class="group ring-default transition-colors relative flex h-40 w-full flex-col items-center justify-between overflow-clip rounded-md p-2 hover:bg-stone-100  dark:hover:bg-stone-800"
    >
      <Label>
