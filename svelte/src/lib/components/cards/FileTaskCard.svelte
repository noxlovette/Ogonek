...
<div class="relative">
  ...
  >
    ...
    <button
      ...
      class="group relative flex h-40 w-full flex-col items-center justify-between overflow-clip rounded-md p-2 ring ring-stone-300/40 transition-colors hover:bg-stone-100 dark:ring-stone-600/50 dark:hover:bg-stone-800"
    >
      <Label>
