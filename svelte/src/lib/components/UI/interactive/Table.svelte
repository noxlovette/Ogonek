...
<div class="w-full space-y-4">
  ...
  {:else}
    ...
    >
      ...
      <div
        class="flex items-center justify-between border-t border-stone-300/30 bg-stone-50 px-6 py-3 dark:border-stone-600/30 dark:bg-stone-900/30"
      >
        <div
          class="flex items-center space-x-2 text-sm text-stone-500 dark:text-stone-400"
        >
          <span>
            Showing
